...
# Resgister Data Frames to the built-in connection
band_db <- tbl_polarssql(dplyr::band_members)
instrument_db <- tbl_polarssql(dplyr::band_instruments)

band_db |>
  left_join(instrument_db) |>
  compute()
```
